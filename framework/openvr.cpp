...
namespace framework {
  ...
  string openvr::device_string(device_id index, vr::TrackedDeviceProperty prop, vr::TrackedPropertyError * error) const {
    return buffered_with_error(mem_fn(&vr::IVRSystem::GetStringTrackedDeviceProperty), error, system, index, prop);
  }

  bool openvr::poll() const {
  ...
  const char * openvr::show_tracked_device_class(TrackedDeviceClass c) {
    switch (c) {
  ...
  const char * openvr::show_event_type(int e) {
    switch (e) {
  ...
  // static signals
  signal<void(vr::VREvent_t &)> openvr::on_event;
  signal<void()> openvr::on_process_quit, openvr::on_quit, openvr::on_ipd_changed, openvr::on_hide_render_models, openvr::on_show_render_models, openvr::on_model_skin_settings_have_changed, openvr::on_dashboard_activated, openvr::on_dashboard_deactivated, openvr::on_chaperone_bounds_shown, openvr::on_chaperone_bounds_hidden, openvr::on_chaperone_data_has_changed, openvr::on_chaperone_settings_have_changed, openvr::on_chaperone_temp_data_has_changed, openvr::on_tracked_device_activated, openvr::on_tracked_device_deactivated;
  signal<void(openvr::process_id)> openvr::on_focus_enter, openvr::on_focus_leave, openvr::on_overlay_focus_changed, openvr::on_dashboard_thumb_selected, openvr::on_dashboard_requested;
  signal<void(vr::VREvent_Controller_t &)> openvr::on_button_press, openvr::on_button_unpress, openvr::on_button_touch, openvr::on_button_untouch;
  signal<void(vr::VREvent_Mouse_t &)> openvr::on_mouse_move, openvr::on_mouse_button_up, openvr::on_mouse_button_down, openvr::on_scroll, openvr::on_touchpad_move;
  signal<void(vr::VREvent_Chaperone_t &)> openvr::on_chaperone_universe_changed;
  signal<void(vr::VREvent_Process_t &)> openvr::on_scene_focus_lost, openvr::on_scene_focus_gained,
    openvr::on_scene_application_changed, openvr::on_scene_focus_changed, openvr::on_input_focus_changed, openvr::on_input_focus_captured, openvr::on_input_focus_released, openvr::on_scene_application_secondary_rendering_started;
