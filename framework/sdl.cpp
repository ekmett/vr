...
namespace framework {
  ...
  sdl::sdl(uint32_t flags) : flags(flags) {
  ...
  signal<void()> sdl::on_quit, sdl::on_app_terminating;
  signal<void(filename_t)> sdl::on_drop_file;

  // window events
  signal<void(uint32_t)> sdl::on_window_close, sdl::on_window_shown, sdl::on_window_hidden, sdl::on_window_exposed,
    sdl::on_window_minimized, sdl::on_window_maximized, sdl::on_window_restored,
    sdl::on_window_enter, sdl::on_window_leave, sdl::on_window_focus_gained, sdl::on_window_focus_lost;
  signal<void(uint32_t, int, int)> sdl::on_window_resize, sdl::on_window_size_changed, sdl::on_window_moved;

  // keyboard events
  signal<void(SDL_KeyboardEvent &)> sdl::on_key_down, sdl::on_key_up;

  // mouse events
  signal<void(SDL_MouseMotionEvent &)> sdl::on_mouse_motion;
  signal<void(SDL_MouseButtonEvent &)> sdl::on_mouse_button_down, sdl::on_mouse_button_up;
  signal<void(SDL_MouseWheelEvent &)> sdl::on_mouse_wheel;

  // joystick events
  signal<void(SDL_JoyButtonEvent &)> sdl::on_joy_button_down, sdl::on_joy_button_up;
  signal<void(SDL_JoyAxisEvent &)> sdl::on_joy_axis_motion;
  signal<void(SDL_JoyBallEvent &)> sdl::on_joy_ball_motion;
  signal<void(SDL_JoyHatEvent &)> sdl::on_joy_hat_motion;
  signal<void(uint32_t)> sdl::on_joy_device_added, sdl::on_joy_device_removed;
  signal<void(SDL_ControllerAxisEvent &)> sdl::on_controller_axis_motion;
  signal<void(SDL_ControllerButtonEvent &)> sdl::on_controller_button_down, sdl::on_controller_button_up;
  signal<void(SDL_ControllerDeviceEvent &)> sdl::on_controller_device_added, sdl::on_controller_device_removed, sdl::on_controller_device_remapped;
  // text editing
  signal<void(SDL_TextEditingEvent &)> sdl::on_text_editing;
  signal<void(SDL_TextInputEvent &)> sdl::on_text_input;

  // audio devices
  signal<void(SDL_AudioDeviceEvent &)> sdl::on_audio_device_added, sdl::on_audio_device_removed;
  signal<void(SDL_Event &)> sdl::on_event;

  static int sdl_event_filter(void * userdata, SDL_Event * e) {
    if (!e || !sdl::on_event.empty()) return 1;
    switch (e->type) {
      // explicitly hooked
      case SDL_QUIT:
      ...
      case SDL_WINDOWEVENT: {
        switch (e->window.event) {
          case SDL_WINDOWEVENT_SHOWN: return !sdl::on_window_shown.empty();
          case SDL_WINDOWEVENT_HIDDEN: return !sdl::on_window_hidden.empty();
          case SDL_WINDOWEVENT_CLOSE: return !sdl::on_window_close.empty();
          case SDL_WINDOWEVENT_EXPOSED: return !sdl::on_window_exposed.empty();
          case SDL_WINDOWEVENT_MINIMIZED: return !sdl::on_window_minimized.empty();
          case SDL_WINDOWEVENT_MAXIMIZED: return !sdl::on_window_maximized.empty();
          case SDL_WINDOWEVENT_RESTORED: return !sdl::on_window_restored.empty();
          case SDL_WINDOWEVENT_ENTER: return !sdl::on_window_enter.empty();
          case SDL_WINDOWEVENT_LEAVE: return !sdl::on_window_leave.empty();
          case SDL_WINDOWEVENT_FOCUS_GAINED: return !sdl::on_window_focus_gained.empty();
          case SDL_WINDOWEVENT_FOCUS_LOST: return !sdl::on_window_focus_lost.empty();
          case SDL_WINDOWEVENT_SIZE_CHANGED: return !sdl::on_window_size_changed.empty();
          case SDL_WINDOWEVENT_RESIZED: return !sdl::on_window_resize.empty();
          default: return 1;
        }
      case SDL_KEYUP: return !sdl::on_key_up.empty();
      case SDL_MOUSEBUTTONDOWN: return !sdl::on_mouse_button_down.empty();
      case SDL_MOUSEBUTTONUP: return !sdl::on_mouse_button_up.empty();
      case SDL_MOUSEMOTION: return !sdl::on_mouse_motion.empty();
      case SDL_MOUSEWHEEL: return !sdl::on_mouse_wheel.empty();

        // joysticks
      case SDL_JOYBUTTONUP: return !sdl::on_joy_button_up.empty();
      case SDL_JOYBUTTONDOWN: return !sdl::on_joy_button_down.empty();
      case SDL_JOYAXISMOTION: return !sdl::on_joy_axis_motion.empty();
      case SDL_JOYBALLMOTION: return !sdl::on_joy_ball_motion.empty();
      case SDL_JOYDEVICEADDED: return !sdl::on_joy_device_added.empty();
      case SDL_JOYDEVICEREMOVED: return !sdl::on_joy_device_removed.empty();
      case SDL_JOYHATMOTION: return !sdl::on_joy_hat_motion.empty();
      case SDL_CONTROLLERAXISMOTION: return !sdl::on_controller_axis_motion.empty();
      case SDL_CONTROLLERBUTTONDOWN: return !sdl::on_controller_button_down.empty();
      case SDL_CONTROLLERBUTTONUP: return !sdl::on_controller_button_up.empty();
      case SDL_CONTROLLERDEVICEADDED: return !sdl::on_controller_device_added.empty();
      case SDL_CONTROLLERDEVICEREMOVED: return !sdl::on_controller_device_removed.empty();
      case SDL_CONTROLLERDEVICEREMAPPED: return !sdl::on_controller_device_remapped.empty();

        // text
      case SDL_TEXTEDITING: return !sdl::on_text_editing.empty();
      case SDL_TEXTINPUT: return !sdl::on_text_input.empty();

        // audio devices
      case SDL_AUDIODEVICEADDED: return !sdl::on_audio_device_added.empty();
      case SDL_AUDIODEVICEREMOVED: return !sdl::on_audio_device_removed.empty();

      // don't know, don't care, maybe should log
      default: 
        log("sdl")->warn("Filtering unhandled event: {} ({})", sdl::show_event(e->type), e->type);
        return 0;
      }
    }
  }
  ...
  const char * sdl::show_event(uint32_t e) {
    switch (e) {
